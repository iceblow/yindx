...
<body>
    ...
    <div class="right">
        ...
        <div class="lineBox lineBox45_22">
        	...
        	<input type="text" class="ltextInput" id="add_title">
        	<div class="box">
                <div class="labelName70 ln">类别</div>
                <input type="text" class="selectInput" readonly="readonly" unselectable="on" id="add_type">
        ...
        <div class="lineBox lineBox0_22">
        	...
        	<textarea class="bigtext  height351" contenteditable="true" id="add_content"></textarea>
        </div>
        <div class="lineBox lineBox0_24">
        	<div class="lineLabel">图片</div>
        	<div class="addPic">添加文件<input type="file" class="fileInput file"  id="file" name="file" multiple></div>
        	<input type="hidden" value="" name="imgs" id="pic_file">
        </div>
